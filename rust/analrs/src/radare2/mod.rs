...
pub const R_ANAL_OP_TYPE_IRCALL: u32 = R_ANAL_OP_TYPE_IND | R_ANAL_OP_TYPE_REG | R_ANAL_OP_TYPE_UCALL;
...
pub struct RAnalPlugin {
    ...
    pub op: Option<extern "C" fn(user: *mut c_void, op: *mut RAnalOp, addr: u64, data: *mut c_void, len: usize, mask: usize) -> c_int>,
