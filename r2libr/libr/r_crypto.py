...
try:
    ...
    pass
class struct_des_context_t(Structure):
    pass

struct_des_context_t._pack_ = 1 # source:False
struct_des_context_t._fields_ = [
    ('round_key_lo', ctypes.c_uint32 * 16),
    ('round_key_hi', ctypes.c_uint32 * 16),
    ('round', ctypes.c_int32),
]

RDESContext = struct_des_context_t
try:
    r_des_permute_key = _libr_crypto.r_des_permute_key
    r_des_permute_key.restype = None
    r_des_permute_key.argtypes = [ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32)]
except AttributeError:
    pass
try:
    r_des_permute_block0 = _libr_crypto.r_des_permute_block0
    r_des_permute_block0.restype = None
    r_des_permute_block0.argtypes = [ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32)]
except AttributeError:
    pass
try:
    r_des_permute_block1 = _libr_crypto.r_des_permute_block1
    r_des_permute_block1.restype = None
    r_des_permute_block1.argtypes = [ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32)]
except AttributeError:
    pass
try:
    r_des_round_key = _libr_crypto.r_des_round_key
    r_des_round_key.restype = None
    r_des_round_key.argtypes = [ctypes.c_int32, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32)]
except AttributeError:
    pass
try:
    r_des_round = _libr_crypto.r_des_round
    r_des_round.restype = None
    r_des_round.argtypes = [ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32)]
except AttributeError:
    pass
...
try:
    ...
    pass
FK = [0xa3b1bac6,0x56aa3350,0x677d9197,0xb27022dc] # Variable ctypes.c_uint32 * 4
sm4_CK = [0x00070e15,0x1c232a31,0x383f464d,0x545b6269,0x70777e85,0x8c939aa1,0xa8afb6bd,0xc4cbd2d9,0xe0e7eef5,0xfc030a11,0x181f262d,0x343b4249,0x50575e65,0x6c737a81,0x888f969d,0xa4abb2b9,0xc0c7ced5,0xdce3eaf1,0xf8ff060d,0x141b2229,0x30373e45,0x4c535a61,0x686f767d,0x848b9299,0xa0a7aeb5,0xbcc3cad1,0xd8dfe6ed,0xf4fb0209,0x10171e25,0x2c333a41,0x484f565d,0x646b7279] # Variable ctypes.c_uint32 * 32
sm4_sbox = ['0xd6', '0x90', '0xe9', '0xfe', '0xcc', '0xe1', '0x3d', '0xb7', '0x16', '0xb6', '0x14', '0xc2', '0x28', '0xfb', '0x2c', '0x05', '0x2b', '0x67', '0x9a', '0x76', '0x2a', '0xbe', '0x04', '0xc3', '0xaa', '0x44', '0x13', '0x26', '0x49', '0x86', '0x06', '0x99', '0x9c', '0x42', '0x50', '0xf4', '0x91', '0xef', '0x98', '0x7a', '0x33', '0x54', '0x0b', '0x43', '0xed', '0xcf', '0xac', '0x62', '0xe4', '0xb3', '0x1c', '0xa9', '0xc9', '0x08', '0xe8', '0x95', '0x80', '0xdf', '0x94', '0xfa', '0x75', '0x8f', '0x3f', '0xa6', '0x47', '0x07', '0xa7', '0xfc', '0xf3', '0x73', '0x17', '0xba', '0x83', '0x59', '0x3c', '0x19', '0xe6', '0x85', '0x4f', '0xa8', '0x68', '0x6b', '0x81', '0xb2', '0x71', '0x64', '0xda', '0x8b', '0xf8', '0xeb', '0x0f', '0x4b', '0x70', '0x56', '0x9d', '0x35', '0x1e', '0x24', '0x0e', '0x5e', '0x63', '0x58', '0xd1', '0xa2', '0x25', '0x22', '0x7c', '0x3b', '0x01', '0x21', '0x78', '0x87', '0xd4', '0x00', '0x46', '0x57', '0x9f', '0xd3', '0x27', '0x52', '0x4c', '0x36', '0x02', '0xe7', '0xa0', '0xc4', '0xc8', '0x9e', '0xea', '0xbf', '0x8a', '0xd2', '0x40', '0xc7', '0x38', '0xb5', '0xa3', '0xf7', '0xf2', '0xce', '0xf9', '0x61', '0x15', '0xa1', '0xe0', '0xae', '0x5d', '0xa4', '0x9b', '0x34', '0x1a', '0x55', '0xad', '0x93', '0x32', '0x30', '0xf5', '0x8c', '0xb1', '0xe3', '0x1d', '0xf6', '0xe2', '0x2e', '0x82', '0x66', '0xca', '0x60', '0xc0', '0x29', '0x23', '0xab', '0x0d', '0x53', '0x4e', '0x6f', '0xd5', '0xdb', '0x37', '0x45', '0xde', '0xfd', '0x8e', '0x2f', '0x03', '0xff', '0x6a', '0x72', '0x6d', '0x6c', '0x5b', '0x51', '0x8d', '0x1b', '0xaf', '0x92', '0xbb', '0xdd', '0xbc', '0x7f', '0x11', '0xd9', '0x5c', '0x41', '0x1f', '0x10', '0x5a', '0xd8', '0x0a', '0xc1', '0x31', '0x88', '0xa5', '0xcd', '0x7b', '0xbd', '0x2d', '0x74', '0xd0', '0x12', '0xb8', '0xe5', '0xb4', '0xb0', '0x89', '0x69', '0x97', '0x4a', '0x0c', '0x96', '0x77', '0x7e', '0x65', '0xb9', '0xf1', '0x09', '0xc5', '0x6e', '0xc6', '0x84', '0x18', '0xf0', '0x7d', '0xec', '0x3a', '0xdc', '0x4d', '0x20', '0x79', '0xee', '0x5f', '0x3e', '0xd7', '0xcb', '0x39', '0x48'] # Variable ctypes.c_ubyte * 256
try:
    sm4_RK = _libraries['FIXME_STUB'].sm4_RK
    sm4_RK.restype = uint32_t
    sm4_RK.argtypes = [uint32_t]
except AttributeError:
    pass
try:
    sm4_round = _libraries['FIXME_STUB'].sm4_round
    sm4_round.restype = None
    sm4_round.argtypes = [ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_ubyte), ctypes.POINTER(ctypes.c_ubyte)]
except AttributeError:
    pass
try:
    sm4_init = _libraries['FIXME_STUB'].sm4_init
    sm4_init.restype = ctypes.c_bool
    sm4_init.argtypes = [ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32, ctypes.c_int32]
except AttributeError:
    pass
try:
...
# values for enumeration 'RCryptoType'
RCryptoType__enumvalues = {
    101: 'R_CRYPTO_TYPE_ENCODER',
    104: 'R_CRYPTO_TYPE_HASH',
    99: 'R_CRYPTO_TYPE_ENCRYPT',
}
R_CRYPTO_TYPE_ENCODER = 101
R_CRYPTO_TYPE_HASH = 104
R_CRYPTO_TYPE_ENCRYPT = 99
RCryptoType = ctypes.c_uint32 # enum
class struct_r_crypto_job_t(Structure):
    pass
...
struct_r_crypto_plugin_t._fields_ = [
    ...
    ('implements', ctypes.POINTER(ctypes.c_char)),
    ('type', RCryptoType),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('check', ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(ctypes.c_char))),
    ('get_key_size', ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct_r_crypto_job_t))),
    ('set_iv', ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32)),
    ('set_key', ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32, ctypes.c_int32, ctypes.c_int32)),
    ('begin', ctypes.CFUNCTYPE(ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(struct_r_crypto_t))),
    ('update', ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32)),
    ('end', ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32)),
    ('fini', ctypes.CFUNCTYPE(ctypes.c_bool, ctypes.POINTER(struct_r_crypto_job_t))),
]

struct_r_crypto_job_t._pack_ = 1 # source:False
struct_r_crypto_job_t._fields_ = [
    ('h', ctypes.POINTER(struct_r_crypto_plugin_t)),
    ('c', ctypes.POINTER(struct_r_crypto_t)),
    ('flag', ctypes.c_int32),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ...
    ('PADDING_2', ctypes.c_ubyte * 4),
    ('plugins', ctypes.POINTER(struct_r_list_t)),
    ('sm4_sk', ctypes.c_uint32 * 32),
    ('data', ctypes.POINTER(None)),
    ('cps2key', ctypes.c_uint32 * 2),
    ('rot_key', ctypes.c_ubyte),
    ('PADDING_3', ctypes.c_ubyte * 7),
    ('entropy', ctypes.c_double),
]

RCrypto = struct_r_crypto_t
RCryptoJob = struct_r_crypto_job_t
RCryptoPlugin = struct_r_crypto_plugin_t
class struct_r_hash_plugin_t(Structure):
    pass

struct_r_hash_plugin_t._pack_ = 1 # source:False
struct_r_hash_plugin_t._fields_ = [
    ('name', ctypes.POINTER(ctypes.c_char)),
    ('author', ctypes.POINTER(ctypes.c_char)),
    ('license', ctypes.POINTER(ctypes.c_char)),
]

RHashPlugin = struct_r_hash_plugin_t
RCryptoSelector = ctypes.c_uint64
try:
    r_crypto_init = _libr_crypto.r_crypto_init
    r_crypto_init.restype = None
    r_crypto_init.argtypes = [ctypes.POINTER(struct_r_crypto_t)]
except AttributeError:
    pass
try:
    r_crypto_add = _libr_crypto.r_crypto_add
    r_crypto_add.restype = ctypes.c_bool
...
try:
    ...
    r_crypto_free.restype = None
    r_crypto_free.argtypes = [ctypes.POINTER(struct_r_crypto_t)]
except AttributeError:
    pass
try:
    r_crypto_list = _libr_crypto.r_crypto_list
    r_crypto_list.restype = None
    r_crypto_list.argtypes = [ctypes.POINTER(struct_r_crypto_t), PrintfCallback, ctypes.c_int32]
except AttributeError:
    pass
try:
    r_crypto_use = _libr_crypto.r_crypto_use
    r_crypto_use.restype = ctypes.POINTER(struct_r_crypto_job_t)
    r_crypto_use.argtypes = [ctypes.POINTER(struct_r_crypto_t), ctypes.POINTER(ctypes.c_char)]
except AttributeError:
    pass
try:
    r_crypto_job_set_key = _libr_crypto.r_crypto_job_set_key
    r_crypto_job_set_key.restype = ctypes.c_bool
    r_crypto_job_set_key.argtypes = [ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32, ctypes.c_int32, ctypes.c_int32]
except AttributeError:
    pass
try:
    r_crypto_job_set_iv = _libr_crypto.r_crypto_job_set_iv
    r_crypto_job_set_iv.restype = ctypes.c_bool
    r_crypto_job_set_iv.argtypes = [ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32]
except AttributeError:
    pass
try:
    r_crypto_job_new = _libr_crypto.r_crypto_job_new
    r_crypto_job_new.restype = ctypes.POINTER(struct_r_crypto_job_t)
    r_crypto_job_new.argtypes = [ctypes.POINTER(struct_r_crypto_t), ctypes.POINTER(struct_r_crypto_plugin_t)]
except AttributeError:
    pass
try:
    r_crypto_job_free = _libr_crypto.r_crypto_job_free
    r_crypto_job_free.restype = None
    r_crypto_job_free.argtypes = [ctypes.POINTER(struct_r_crypto_job_t)]
except AttributeError:
    pass
try:
    r_crypto_begin = _libraries['FIXME_STUB'].r_crypto_begin
    r_crypto_begin.restype = ctypes.POINTER(struct_r_crypto_job_t)
    r_crypto_begin.argtypes = [ctypes.POINTER(struct_r_crypto_t)]
except AttributeError:
    pass
try:
    r_crypto_job_update = _libr_crypto.r_crypto_job_update
    r_crypto_job_update.restype = ctypes.c_bool
    r_crypto_job_update.argtypes = [ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32]
except AttributeError:
    pass
try:
    r_crypto_job_end = _libr_crypto.r_crypto_job_end
    r_crypto_job_end.restype = ctypes.c_bool
    r_crypto_job_end.argtypes = [ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32]
except AttributeError:
    pass
try:
    r_crypto_job_append = _libr_crypto.r_crypto_job_append
    r_crypto_job_append.restype = ctypes.c_int32
    r_crypto_job_append.argtypes = [ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32]
except AttributeError:
    pass
try:
    r_crypto_job_get_output = _libr_crypto.r_crypto_job_get_output
    r_crypto_job_get_output.restype = ctypes.POINTER(ctypes.c_ubyte)
    r_crypto_job_get_output.argtypes = [ctypes.POINTER(struct_r_crypto_job_t), ctypes.POINTER(ctypes.c_int32)]
except AttributeError:
    pass
...
r_crypto_plugin_sm4 = struct_r_crypto_plugin_t # Variable struct_r_crypto_plugin_t
r_crypto_plugin_aes_wrap = struct_r_crypto_plugin_t # Variable struct_r_crypto_plugin_t
r_crypto_plugin_entropy = struct_r_crypto_plugin_t # Variable struct_r_crypto_plugin_t
__all__ = \
    ...
    'DT_SOCK', 'DT_UNKNOWN', 'DT_WHT', 'FILE', 'FK', 'FPE_CONDTRAP',
    ...
    'RColor', 'RCons', 'RConsBind', 'RConsBreak',
    ...
    'RCoreHelpMessage', 'RCrypto', 'RCryptoJob', 'RCryptoPlugin',
    'RCryptoSelector', 'RCryptoType', 'RDESContext', 'RDiff',
    ...
    'REventIOWrite', 'REventMeta', 'REventType', 'RFree', 'RGetopt',
    'RGraph', 'RGraphEdge', 'RGraphEdgeCallback', 'RGraphNode',
    'RGraphNodeCallback', 'RGraphVisitor', 'RHashPlugin', 'RIDPool',
    'RIDStorage', 'RIDStorageForeachCb', 'RInterval',
    'RIntervalIterCb', 'RIntervalNode', 'RIntervalNodeFree',
    'RIntervalTree', 'RIntervalTreeIter', 'RLevBuf', 'RLevMatches',
    'RLevOp', 'RLine', 'RLineBuffer', 'RLineCompletion',
    'RLineCompletionCb', 'RLineEditorCb', 'RLineHistory',
    'RLineHistoryDownCb', 'RLineHistoryUpCb', 'RLineHud',
    'RLinePromptType', 'RLineReadCallback', 'RList',
    ...
    'R_CONS_ERRMODE_QUIET', 'R_CRYPTO_DIR_CIPHER',
    'R_CRYPTO_DIR_DECIPHER', 'R_CRYPTO_MODE_CBC', 'R_CRYPTO_MODE_CFB',
    'R_CRYPTO_MODE_ECB', 'R_CRYPTO_MODE_OFB', 'R_CRYPTO_TYPE_ENCODER',
    'R_CRYPTO_TYPE_ENCRYPT', 'R_CRYPTO_TYPE_HASH', 'R_EVENT_ALL',
    ...
    'c__Ea_R_CONS_ERRMODE_NULL', 'c__Ea_R_CRYPTO_DIR_CIPHER',
    'c__Ea_R_CRYPTO_MODE_ECB', 'c__Ea_R_TABLE_ALIGN_LEFT',
    ...
    'r_crbtree_new', 'r_crbtree_take', 'r_crypto_add',
    'r_crypto_begin', 'r_crypto_free', 'r_crypto_init',
    'r_crypto_job_append', 'r_crypto_job_end', 'r_crypto_job_free',
    'r_crypto_job_get_output', 'r_crypto_job_new',
    'r_crypto_job_set_iv', 'r_crypto_job_set_key',
    'r_crypto_job_update', 'r_crypto_list', 'r_crypto_new',
    'r_crypto_plugin_aes', 'r_crypto_plugin_aes_cbc',
    'r_crypto_plugin_aes_wrap', 'r_crypto_plugin_base64',
    'r_crypto_plugin_base91', 'r_crypto_plugin_blowfish',
    'r_crypto_plugin_cps2', 'r_crypto_plugin_des',
    'r_crypto_plugin_entropy', 'r_crypto_plugin_punycode',
    'r_crypto_plugin_rc2', 'r_crypto_plugin_rc4',
    'r_crypto_plugin_rc6', 'r_crypto_plugin_rol',
    'r_crypto_plugin_ror', 'r_crypto_plugin_rot',
    'r_crypto_plugin_serpent', 'r_crypto_plugin_sm4',
    'r_crypto_plugin_xor', 'r_crypto_use', 'r_crypto_version',
    'r_ctime_r', 'r_debruijn_offset', 'r_debruijn_pattern',
    'r_des_permute_block0', 'r_des_permute_block1',
    'r_des_permute_key', 'r_des_round', 'r_des_round_key',
    ...
    'sm4_CK', 'sm4_RK', 'sm4_init', 'sm4_round', 'sm4_sbox',
    ...
    'struct_des_context_t', 'struct_dict', 'struct_dictkv',
    'struct_dirent', 'struct_div_t', 'struct_drand48_data',
    'struct_fd_set', 'struct_flock', 'struct_ht_pp_bucket_t',
    ...
    'struct_r_crypto_job_t', 'struct_r_crypto_plugin_t',
    'struct_r_crypto_t', 'struct_r_diff_op_t', 'struct_r_diff_t',
    ...
    'struct_r_graph_visitor_t', 'struct_r_hash_plugin_t',
