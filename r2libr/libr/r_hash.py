...
r_hash_new.argtypes = [ctypes.c_bool, uint64_t]
...
r_hash_name.argtypes = [uint64_t]
r_hash_name_to_bits = _libr_hash.r_hash_name_to_bits
r_hash_name_to_bits.restype = uint64_t
...
r_hash_size.argtypes = [uint64_t]
r_hash_calculate = _libr_hash.r_hash_calculate
r_hash_calculate.restype = ctypes.c_int32
r_hash_calculate.argtypes = [ctypes.POINTER(struct_r_hash_t), uint64_t, ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32]
r_hash_deviation = _libr_hash.r_hash_deviation
r_hash_deviation.restype = uint8_t
r_hash_deviation.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_adler32 = _libr_hash.r_hash_adler32
r_hash_adler32.restype = uint32_t
r_hash_adler32.argtypes = [ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int32]
r_hash_xxhash = _libr_hash.r_hash_xxhash
r_hash_xxhash.restype = uint32_t
r_hash_xxhash.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_xor = _libr_hash.r_hash_xor
r_hash_xor.restype = uint8_t
r_hash_xor.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_xorpair = _libr_hash.r_hash_xorpair
r_hash_xorpair.restype = uint16_t
r_hash_xorpair.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_parity = _libr_hash.r_hash_parity
r_hash_parity.restype = ctypes.c_int32
r_hash_parity.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_mod255 = _libr_hash.r_hash_mod255
r_hash_mod255.restype = uint8_t
r_hash_mod255.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_luhn = _libr_hash.r_hash_luhn
r_hash_luhn.restype = uint64_t
r_hash_luhn.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
...
r_hash_crc_preset.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint32_t, CRC_PRESETS]
r_hash_hamdist = _libr_hash.r_hash_hamdist
r_hash_hamdist.restype = uint8_t
...
r_hash_entropy.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_entropy_fraction = _libr_hash.r_hash_entropy_fraction
r_hash_entropy_fraction.restype = ctypes.c_double
r_hash_entropy_fraction.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_pcprint = _libr_hash.r_hash_pcprint
r_hash_pcprint.restype = ctypes.c_int32
r_hash_pcprint.argtypes = [ctypes.POINTER(ctypes.c_ubyte), uint64_t]
r_hash_do_begin = _libr_hash.r_hash_do_begin
r_hash_do_begin.restype = None
r_hash_do_begin.argtypes = [ctypes.POINTER(struct_r_hash_t), uint64_t]
r_hash_do_end = _libr_hash.r_hash_do_end
r_hash_do_end.restype = None
r_hash_do_end.argtypes = [ctypes.POINTER(struct_r_hash_t), uint64_t]
r_hash_do_spice = _libr_hash.r_hash_do_spice
r_hash_do_spice.restype = None
r_hash_do_spice.argtypes = [ctypes.POINTER(struct_r_hash_t), uint64_t, ctypes.c_int32, ctypes.POINTER(struct_r_hash_seed_t)]
__all__ = \
    ...
    'struct_r_hash_seed_t', 'struct_r_hash_t', 'uint16_t', 'uint32_t',
    'uint64_t', 'uint8_t', 'utcrc']
