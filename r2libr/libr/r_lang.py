...
try:
    ...
    r_lang_list.restype = None
    r_lang_list.argtypes = [ctypes.POINTER(struct_r_lang_t), ctypes.c_int32]
except AttributeError:
    pass
try:
...
try:
    ...
    pass
__all__ = \
    ['BufferOp', 'DIR', 'DT_BLK', 'DT_CHR', 'DT_DIR', 'DT_FIFO',
    'DT_LNK', 'DT_REG', 'DT_SOCK', 'DT_UNKNOWN', 'DT_WHT', 'FILE',
    'FP_INFINITE', 'FP_NAN', 'FP_NORMAL', 'FP_SUBNORMAL', 'FP_ZERO',
    'GperfForeachCallback', 'HtPP', 'HtPPBucket', 'HtPPCalcSizeK',
    'HtPPCalcSizeV', 'HtPPDupKey', 'HtPPDupValue',
    'HtPPForeachCallback', 'HtPPHashFunction', 'HtPPKv',
    'HtPPKvFreeFunc', 'HtPPListComparator', 'HtPPOptions',
    'ITIMER_PROF', 'ITIMER_REAL', 'ITIMER_VIRTUAL', 'PrintfCallback',
    'RCoreCmdStrCallback', 'RCoreCmdfCallback', 'RLang', 'RLangDef',
    'RLangPlugin', 'RList', 'RListComparator', 'RListComparatorItem',
    'RListFree', 'RListIter', 'RListRange', 'RSysArch',
    'R_SYS_ARCH_8051', 'R_SYS_ARCH_ARC', 'R_SYS_ARCH_ARM',
    'R_SYS_ARCH_AVR', 'R_SYS_ARCH_BF', 'R_SYS_ARCH_BPF',
    ...
    'ceill', 'chdir', 'chmod', 'chown', 'chroot', 'clearenv',
    'clearerr', 'clearerr_unlocked', 'clock_t', 'clockid_t', 'close',
    'closedir', 'closefrom', 'confstr', 'cookie_close_function_t',
    'cookie_io_functions_t', 'cookie_read_function_t',
    'cookie_seek_function_t', 'cookie_write_function_t', 'copysign',
    'copysignf', 'copysignl', 'cos', 'cosf', 'cosh', 'coshf', 'coshl',
    'cosl', 'creat', 'crypt', 'ctermid', 'daddr_t', 'daemon', 'dev_t',
    'dict', 'dict_add', 'dict_del', 'dict_fini', 'dict_foreach',
    'dict_free', 'dict_freecb', 'dict_get', 'dict_getr', 'dict_getu',
    'dict_hash', 'dict_init', 'dict_new', 'dict_set', 'dict_stats',
    'dicti', 'dictkv', 'dictkv_cb', 'dirfd', 'div', 'div_t',
    ...
    'gid_t', 'ht_pp_delete', 'ht_pp_find', 'ht_pp_find_kv',
    'ht_pp_foreach', 'ht_pp_free', 'ht_pp_insert', 'ht_pp_insert_kv',
    'ht_pp_new', 'ht_pp_new0', 'ht_pp_new_opt', 'ht_pp_new_size',
    'ht_pp_update', 'ht_pp_update_key', 'hypot', 'hypotf', 'hypotl',
    'id_t', 'ilogb', 'ilogbf', 'ilogbl', 'imaxabs', 'imaxdiv',
    ...
    'intptr_t', 'isalnum', 'isalnum_l', 'isalpha', 'isalpha_l',
    'isascii', 'isatty', 'isblank', 'isblank_l', 'iscntrl',
    'iscntrl_l', 'isdigit', 'isdigit_l', 'isgraph', 'isgraph_l',
    'isinf', 'isinff', 'isinfl', 'islower', 'islower_l', 'isnan',
    'isnanf', 'isnanl', 'isprint', 'isprint_l', 'ispunct',
    ...
    'lround', 'lroundf', 'lroundl', 'ls_append', 'ls_clone',
    ...
    'mempcpy', 'memset', 'mkdir', 'mkdirat', 'mkdtemp', 'mkfifo',
    'mkfifoat', 'mknod', 'mknodat', 'mkstemp', 'mkstemps', 'mktemp',
    'mode_t', 'modf', 'modff', 'modfl', 'mrand48', 'mrand48_r', 'nan',
    'nanf', 'nanl', 'nearbyint', 'nearbyintf', 'nearbyintl',
    'nextafter', 'nextafterf', 'nextafterl', 'nexttoward',
    'nexttowardf', 'nexttowardl', 'nice', 'nlink_t', 'nrand48',
    'nrand48_r', 'off_t', 'on_exit', 'open', 'open_memstream',
    'openat', 'opendir', 'optarg', 'opterr', 'optind', 'optopt',
    'pathconf', 'pause', 'pclose', 'perror', 'pid_t', 'pipe', 'popen',
    ...
    'quick_exit', 'r_lang_add', 'r_lang_def_free', 'r_lang_define',
    ...
    'r_list_add_sorted', 'r_list_append', 'r_list_clone',
    'r_list_contains', 'r_list_del_n', 'r_list_delete',
    'r_list_delete_data', 'r_list_find', 'r_list_first',
    'r_list_free', 'r_list_get_bottom', 'r_list_get_n',
    'r_list_get_top', 'r_list_init', 'r_list_insert',
    ...
    'r_run_call7', 'r_run_call8', 'r_run_call9', 'r_swap_st16',
    'r_swap_st32', 'r_swap_st64', 'r_swap_ut16', 'r_swap_ut32',
    'r_swap_ut64', 'r_write_at_be16', 'r_write_at_be32',
    'r_write_at_be64', 'r_write_at_be8', 'r_write_at_ble8',
    'r_write_at_le16', 'r_write_at_le32', 'r_write_at_le64',
    'r_write_at_le8', 'r_write_at_me16', 'r_write_at_me32',
    'r_write_at_me64', 'r_write_at_me8', 'r_write_be16',
    'r_write_be24', 'r_write_be32', 'r_write_be64', 'r_write_be8',
    'r_write_ble', 'r_write_ble16', 'r_write_ble24', 'r_write_ble32',
    'r_write_ble64', 'r_write_ble8', 'r_write_le16', 'r_write_le24',
    'r_write_le32', 'r_write_le64', 'r_write_le8', 'r_write_me16',
    'r_write_me32', 'r_write_me64', 'r_write_me8', 'rand', 'rand_r',
    'random', 'random_r', 'read', 'readdir', 'readdir_r', 'readlink',
    'readlinkat', 'realloc', 'reallocarray', 'realpath', 'register_t',
    'remainder', 'remainderf', 'remainderl', 'remove', 'remquo',
    'remquof', 'remquol', 'rename', 'renameat', 'revoke', 'rewind',
    'rewinddir', 'rindex', 'rint', 'rintf', 'rintl', 'rmdir', 'round',
    'roundf', 'roundl', 'rpmatch', 'sbrk', 'scalb', 'scalbf',
    'scalbl', 'scalbln', 'scalblnf', 'scalblnl', 'scalbn', 'scalbnf',
    'scalbnl', 'scandir', 'scanf', 'sdb_add', 'sdb_alen',
    'sdb_alen_ignore_empty', 'sdb_anext', 'sdb_array_add',
    ...
    'seek_set', 'seekdir', 'select', 'setbuf', 'setbuffer',
    ...
    'strtouq', 'struct_SdbJsonString', 'struct__G_fpos64_t',
    ...
    'struct__ut80', 'struct__ut96', 'struct__utX', 'struct_buffer',
    'struct_cdb', 'struct_cdb_hp', 'struct_cdb_hplist',
    'struct_cdb_make', 'struct_dict', 'struct_dictkv',
    ...
    'struct_imaxdiv_t', 'struct_itimerval', 'struct_ldiv_t',
    'struct_lldiv_t', 'struct_ls_iter_t', 'struct_ls_t',
    'struct_max_align_t', 'struct_r_lang_def_t',
    'struct_r_lang_plugin_t', 'struct_r_lang_t',
    'struct_r_list_iter_t', 'struct_r_list_range_t',
    'struct_r_list_t', 'struct_random_data', 'struct_sdb_diff_t',
    'struct_sdb_gperf_t', 'struct_sdb_kv', 'struct_sdb_ns_t',
    'struct_sdb_t', 'struct_stat', 'struct_timespec',
    ...
    'union_pthread_rwlockattr_t', 'union_utAny', 'unlink', 'unlinkat',
    'unsetenv', 'useconds_t', 'ushort', 'usleep', 'ust16', 'ust32',
    'ust64', 'ut128', 'ut256', 'ut32_pack', 'ut32_pack_big',
    ...
    'vhangup', 'vprintf', 'vscanf', 'vsnprintf', 'vsprintf',
    'vsscanf', 'wchar_t', 'wcstoimax', 'wcstombs', 'wcstoumax',
