...
__all__ = \
    ...
    'ITIMER_PROF', 'ITIMER_REAL', 'ITIMER_VIRTUAL', 'LINE_FALSE',
    ...
    'PrintfCallback', 'QUIT', 'RCanvasLineStyle', 'RCharset',
    'RCharsetRune', 'RColor', 'RCons', 'RConsBind', 'RConsBreak',
    ...
    'RCoreHelpMessage', 'RGraph', 'RGraphEdge', 'RGraphEdgeCallback',
    'RGraphNode', 'RGraphNodeCallback', 'RGraphVisitor', 'RLine',
    ...
    'RLineReadCallback', 'RList', 'RListComparator',
    'RListComparatorItem', 'RListFree', 'RListIter', 'RListRange',
    'RLog', 'RLogCallback', 'RLogLevel', 'RLogLevel__enumvalues',
    'RLogSource', 'RMemoryPool', 'RMmap', 'RModal', 'RNCAND',
    ...
    'RNum', 'RNumCalc', 'RNumCalcToken', 'RNumCalcValue',
    'RNumCallback', 'RNumCallback2', 'RNumFloat', 'ROTATE',
    'RPVector', 'RPVectorComparator', 'RPVectorFree', 'RPanel',
    ...
    'RPanelsRootState', 'RPanelsSnow', 'RSelWidget', 'RStack',
    'RStackFree', 'RStrBuf', 'RStrConstPool', 'RStrEnc',
    'RStrRangeCallback', 'RString', 'RSysArch', 'RSysInfo', 'RThread',
    ...
    'RThreadSemaphore', 'RVector', 'RVectorFree', 'RViMode',
    'R_CONS_ATTR_BLINK', 'R_CONS_ATTR_BOLD', 'R_CONS_ATTR_DIM',
    'R_CONS_ATTR_ITALIC', 'R_CONS_ATTR_UNDERLINE',
    'R_CONS_ERRMODE_BUFFER', 'R_CONS_ERRMODE_ECHO',
    'R_CONS_ERRMODE_FLUSH', 'R_CONS_ERRMODE_NULL',
    'R_CONS_ERRMODE_QUIET', 'R_LINE_PROMPT_DEFAULT',
    'R_LINE_PROMPT_FILE', 'R_LINE_PROMPT_OFFSET', 'R_LOGLVL_DEBUG',
    'R_LOGLVL_ERROR', 'R_LOGLVL_FATAL', 'R_LOGLVL_INFO',
    'R_LOGLVL_LAST', 'R_LOGLVL_TODO', 'R_LOGLVL_WARN',
    ...
    'R_SYS_ARCH_Z80', 'R_TH_FREED', 'R_TH_LOCK_TYPE_HEAP',
    'R_TH_LOCK_TYPE_STATIC', 'R_TH_REPEAT', 'R_TH_STOP', 'SCM_RIGHTS',
    'SEGV_ACCADI', 'SEGV_ACCERR', 'SEGV_ADIDERR', 'SEGV_ADIPERR',
    'SEGV_BNDERR', 'SEGV_CPERR', 'SEGV_MAPERR', 'SEGV_MTEAERR',
    'SEGV_MTESERR', 'SEGV_PKUERR', 'SHUT_RD', 'SHUT_RDWR', 'SHUT_WR',
    'SIGEV_NONE', 'SIGEV_SIGNAL', 'SIGEV_THREAD', 'SIGEV_THREAD_ID',
    'SI_ASYNCIO', 'SI_ASYNCNL', 'SI_DETHREAD', 'SI_KERNEL',
    'SI_MESGQ', 'SI_QUEUE', 'SI_SIGIO', 'SI_TIMER', 'SI_TKILL',
    'SI_USER', 'SOCK_CLOEXEC', 'SOCK_DCCP', 'SOCK_DGRAM',
    'SOCK_NONBLOCK', 'SOCK_PACKET', 'SOCK_RAW', 'SOCK_RDM',
    'SOCK_SEQPACKET', 'SOCK_STREAM', 'SS_DISABLE', 'SS_ONSTACK',
    'ST16_DIV_OVFCHK', 'ST16_MUL_OVFCHK', 'ST32_DIV_OVFCHK',
    'ST32_MUL_OVFCHK', 'ST64_DIV_OVFCHK', 'ST64_MUL_OVFCHK',
    'ST8_DIV_OVFCHK', 'ST8_MUL_OVFCHK', 'SZT_MUL_OVFCHK', 'Sdb',
    'SdbDiff', 'SdbDiffCallback', 'SdbForeachCallback', 'SdbGperf',
    'SdbHook', 'SdbJsonString', 'SdbKv', 'SdbList',
    'SdbListComparator', 'SdbListFree', 'SdbListIter', 'SdbMini',
    'SdbNs', 'UT16_ADD', 'UT16_DIV_OVFCHK', 'UT16_MUL',
    ...
    'asinl', 'asprintf', 'at_quick_exit', 'atan', 'atan2', 'atan2f',
    'atan2l', 'atanf', 'atanh', 'atanhf', 'atanhl', 'atanl', 'atexit',
    'atof', 'atoi', 'atol', 'atoll', 'bcmp', 'bcopy', 'bind',
    'blkcnt_t', 'blksize_t', 'brk', 'bsearch', 'btowc', 'buffer',
    'buffer_bget', 'buffer_copy', 'buffer_feed', 'buffer_flush',
    'buffer_get', 'buffer_init', 'buffer_peek', 'buffer_put',
    'buffer_putalign', 'buffer_putflush', 'buffer_seek', 'bzero',
    'c__Ea_ALPHA_RESET', 'c__Ea_BUS_ADRALN', 'c__Ea_CLD_EXITED',
    'c__Ea_DT_UNKNOWN', 'c__Ea_FPE_INTDIV', 'c__Ea_FP_NAN',
    'c__Ea_ILL_ILLOPC', 'c__Ea_LINE_NONE', 'c__Ea_MSG_OOB',
    'c__Ea_PAL_PROMPT', 'c__Ea_POLL_IN',
    ...
    'c__Ea_R_CONS_ERRMODE_NULL', 'c__Ea_SCM_RIGHTS',
    'c__Ea_SEGV_MAPERR', 'c__Ea_SHUT_RD', 'c__Ea_SIGEV_SIGNAL',
    'c__Ea_SI_ASYNCNL', 'c__Ea_SS_ONSTACK', 'c__Ea__CS_PATH',
    'c__Ea__ISupper', 'c__Ea__PC_LINK_MAX', 'c__Ea__SC_ARG_MAX',
    'c_bool', 'c_bool__enumvalues', 'caddr_t', 'calloc', 'cbrt',
    'cbrtf', 'cbrtl', 'cc_t', 'cdb_findnext', 'cdb_findstart',
    'cdb_free', 'cdb_getkvlen', 'cdb_init', 'cdb_make_add',
    'cdb_make_addbegin', 'cdb_make_addend', 'cdb_make_finish',
    'cdb_make_start', 'cdb_read', 'ceil', 'ceilf', 'ceill',
    'cfgetispeed', 'cfgetospeed', 'cfmakeraw', 'cfsetispeed',
    ...
    'qsort', 'quad_t', 'quick_exit', 'r_assert_log',
    'r_atomic_exchange', 'r_atomic_store', 'r_charset_close',
    ...
    'r_cons_zero', 'r_file_abspath', 'r_file_abspath_rel',
    'r_file_basename', 'r_file_binsh', 'r_file_chmod', 'r_file_copy',
    'r_file_dirname', 'r_file_dump', 'r_file_exists',
    'r_file_extension', 'r_file_fexists', 'r_file_glob',
    'r_file_gzslurp', 'r_file_hexdump', 'r_file_is_abspath',
    'r_file_is_c', 'r_file_is_directory', 'r_file_is_executable',
    'r_file_is_regular', 'r_file_lsrf', 'r_file_mkstemp',
    'r_file_mmap', 'r_file_mmap_arch', 'r_file_mmap_free',
    'r_file_mmap_read', 'r_file_mmap_write', 'r_file_move',
    'r_file_new', 'r_file_path', 'r_file_readlink', 'r_file_rm',
    'r_file_rm_rf', 'r_file_root', 'r_file_size', 'r_file_slurp',
    'r_file_slurp_hexpairs', 'r_file_slurp_line',
    ...
    'r_get_input_num_value', 'r_graph_add_edge',
    'r_graph_add_edge_at', 'r_graph_add_node', 'r_graph_add_nodef',
    'r_graph_adjacent', 'r_graph_all_neighbours', 'r_graph_del_edge',
    'r_graph_del_node', 'r_graph_dfs', 'r_graph_dfs_node',
    'r_graph_dfs_node_reverse', 'r_graph_free',
    ...
    'r_inflate', 'r_inflate_lz4', 'r_inflate_raw',
    'r_is_valid_input_num_value', 'r_line_clipboard_push',
    ...
    'r_line_hist_get_size', 'r_line_hist_label', 'r_line_hist_list',
    'r_line_hist_load', 'r_line_hist_save', 'r_line_hist_set_size',
    'r_line_label_show', 'r_line_new', 'r_line_readline',
    'r_line_readline_cb', 'r_line_set_hist_callback',
    'r_line_set_prompt', 'r_line_singleton', 'r_list_add_sorted',
    ...
    'r_mem_alloc', 'r_mem_cmp_mask', 'r_mem_copybits',
    'r_mem_copybits_delta', 'r_mem_copyloop', 'r_mem_count',
    'r_mem_dup', 'r_mem_eq', 'r_mem_free', 'r_mem_get_num',
    'r_mem_is_printable', 'r_mem_is_zero', 'r_mem_mem',
    'r_mem_mem_aligned', 'r_mem_memzero', 'r_mem_mmap_resize',
    'r_mem_pool_alloc', 'r_mem_pool_deinit', 'r_mem_pool_free',
    'r_mem_pool_new', 'r_mem_protect', 'r_mem_reverse',
    'r_mem_set_num', 'r_mem_swap', 'r_mem_swapendian',
    'r_mem_swaporcopy', 'r_new_copy', 'r_num_abs', 'r_num_as_string',
    'r_num_between', 'r_num_bit_count', 'r_num_calc',
    'r_num_calc_index', 'r_num_chs', 'r_num_conditional', 'r_num_cos',
    'r_num_dup', 'r_num_free', 'r_num_get', 'r_num_get_float',
    'r_num_get_input_value', 'r_num_get_name', 'r_num_irand',
    'r_num_is_op', 'r_num_is_valid_input', 'r_num_math',
    'r_num_minmax_swap', 'r_num_minmax_swap_i', 'r_num_new',
    'r_num_rand', 'r_num_segaddr', 'r_num_sin', 'r_num_str_len',
    'r_num_str_split', 'r_num_str_split_list', 'r_num_tail',
    'r_num_tail_base', 'r_num_to_bits', 'r_num_to_ternary',
    'r_num_units', 'r_pvector_at', 'r_pvector_bsearch',
    'r_pvector_clear', 'r_pvector_contains', 'r_pvector_data',
    'r_pvector_empty', 'r_pvector_fini', 'r_pvector_flush',
    'r_pvector_free', 'r_pvector_index_ptr', 'r_pvector_init',
    'r_pvector_insert', 'r_pvector_insert_range', 'r_pvector_len',
    'r_pvector_new', 'r_pvector_new_with_len', 'r_pvector_pop',
    'r_pvector_pop_front', 'r_pvector_push', 'r_pvector_push_front',
    'r_pvector_remove_at', 'r_pvector_remove_data',
    'r_pvector_reserve', 'r_pvector_set', 'r_pvector_shrink',
    'r_pvector_sort', 'r_qrcode_gen', 'r_read_at_be16',
    ...
    'r_read_le8', 'r_read_me16', 'r_read_me27', 'r_read_me32',
    'r_read_me64', 'r_read_me8', 'r_run_call1', 'r_run_call10',
    'r_run_call2', 'r_run_call3', 'r_run_call4', 'r_run_call5',
    'r_run_call6', 'r_run_call7', 'r_run_call8', 'r_run_call9',
    'r_sandbox_chdir', 'r_sandbox_check', 'r_sandbox_check_path',
    'r_sandbox_close', 'r_sandbox_creat', 'r_sandbox_disable',
    'r_sandbox_enable', 'r_sandbox_fopen', 'r_sandbox_grain',
    'r_sandbox_kill', 'r_sandbox_lseek', 'r_sandbox_open',
    'r_sandbox_opendir', 'r_sandbox_read', 'r_sandbox_system',
    'r_sandbox_truncate', 'r_sandbox_write', 'r_signal_from_string',
    'r_signal_sigmask', 'r_signal_to_human', 'r_signal_to_string',
    'r_snprintf', 'r_stack_free', 'r_stack_is_empty', 'r_stack_new',
    'r_stack_newf', 'r_stack_peek', 'r_stack_pop', 'r_stack_push',
    'r_stack_size', 'r_stdin_slurp', 'r_str_ansi_chrn',
    'r_str_ansi_crop', 'r_str_ansi_filter', 'r_str_ansi_len',
    'r_str_ansi_nlen', 'r_str_ansi_strip', 'r_str_ansi_trim',
    'r_str_append', 'r_str_append_owned', 'r_str_appendch',
    'r_str_appendf', 'r_str_appendlen', 'r_str_arg_escape',
    'r_str_arg_unescape', 'r_str_argv', 'r_str_argv_free',
    'r_str_array_join', 'r_str_between', 'r_str_binstr2bin',
    'r_str_bits', 'r_str_bits64', 'r_str_bits_from_string',
    'r_str_bool', 'r_str_bounds', 'r_str_byte_escape', 'r_str_case',
    'r_str_casecmp', 'r_str_casestr', 'r_str_ccmp', 'r_str_ccpy',
    'r_str_char_count', 'r_str_char_fullwidth', 'r_str_closer_chr',
    'r_str_cmp', 'r_str_cmp_list', 'r_str_constpool_fini',
    'r_str_constpool_get', 'r_str_constpool_init',
    'r_str_contains_macro', 'r_str_crop', 'r_str_delta',
    'r_str_distance', 'r_str_do_until_token', 'r_str_donut',
    'r_str_dup', 'r_str_encoded_json', 'r_str_endswith', 'r_str_eq',
    'r_str_eqi', 'r_str_escape', 'r_str_escape_dot',
    'r_str_escape_latin1', 'r_str_escape_raw', 'r_str_escape_sh',
    'r_str_escape_sql', 'r_str_escape_utf16be',
    ...
    'r_str_sysbits', 'r_str_tok', 'r_str_trim', 'r_str_trim_args',
    ...
    'r_strstr_ansi', 'r_sub_str_lchr', 'r_sub_str_rchr',
    'r_swap_st16', 'r_swap_st32', 'r_swap_st64', 'r_swap_ut16',
    'r_swap_ut32', 'r_swap_ut64', 'r_sys_arch_id', 'r_sys_arch_match',
    'r_sys_arch_str', 'r_sys_aslr', 'r_sys_backtrace', 'r_sys_chdir',
    'r_sys_clearenv', 'r_sys_cmd', 'r_sys_cmd_str',
    'r_sys_cmd_str_full', 'r_sys_cmd_strf', 'r_sys_cmdbg',
    'r_sys_cmdf', 'r_sys_crash_handler', 'r_sys_dir',
    ...
    'r_syscmd_tail', 'r_syscmd_uniq', 'r_th_break',
    'r_th_channel_free', 'r_th_channel_message_free',
    ...
    'r_th_wait_async', 'r_vector_assign', 'r_vector_assign_at',
    'r_vector_clear', 'r_vector_clone', 'r_vector_empty',
    'r_vector_fini', 'r_vector_flush', 'r_vector_free',
    'r_vector_index_ptr', 'r_vector_init', 'r_vector_insert',
    'r_vector_insert_range', 'r_vector_len', 'r_vector_new',
    'r_vector_pop', 'r_vector_pop_front', 'r_vector_push',
    'r_vector_push_front', 'r_vector_remove_at', 'r_vector_reserve',
    'r_vector_shrink', 'r_vlog', 'r_w32_init', 'r_write_at_be16',
    ...
    'r_wstr_clen', 'r_xdg_cachedir', 'r_xdg_configdir',
    'r_xdg_datadir', 'raise_', 'rand', 'rand_r', 'random', 'random_r',
    'read', 'readdir', 'readdir_r', 'readlink', 'readlinkat',
    'realloc', 'reallocarray', 'realpath', 'recv', 'recvfrom',
    'recvmsg', 'register_t', 'remainder', 'remainderf', 'remainderl',
    'remove', 'remquo', 'remquof', 'remquol', 'rename', 'renameat',
    'revoke', 'rewind', 'rewinddir', 'rindex', 'rint', 'rintf',
    'rintl', 'rmdir', 'round', 'roundf', 'roundl', 'rpmatch',
    'sa_family_t', 'sbrk', 'scalb', 'scalbf', 'scalbl', 'scalbln',
    'scalblnf', 'scalblnl', 'scalbn', 'scalbnf', 'scalbnl', 'scandir',
    'scanf', 'sched_get_priority_max', 'sched_get_priority_min',
    'sched_getparam', 'sched_getscheduler', 'sched_rr_get_interval',
    'sched_setparam', 'sched_setscheduler', 'sched_yield', 'sdb_add',
    'sdb_alen', 'sdb_alen_ignore_empty', 'sdb_anext', 'sdb_array_add',
    'sdb_array_add_num', 'sdb_array_add_sorted',
    'sdb_array_add_sorted_num', 'sdb_array_append',
    'sdb_array_append_num', 'sdb_array_compact', 'sdb_array_contains',
    'sdb_array_contains_num', 'sdb_array_delete', 'sdb_array_get',
    'sdb_array_get_idx', 'sdb_array_get_num', 'sdb_array_indexof',
    'sdb_array_insert', 'sdb_array_insert_num', 'sdb_array_length',
    'sdb_array_list', 'sdb_array_pop', 'sdb_array_pop_head',
    'sdb_array_pop_num', 'sdb_array_pop_tail', 'sdb_array_prepend',
    ...
    'struct_RStrBuf', 'struct_RString', 'struct_RSysInfo',
    'struct_RThreadChannel', 'struct_RThreadChannelMessage',
    'struct_RThreadChannelPromise', 'struct_SdbJsonString',
    ...
    'struct_pj_t', 'struct_r_charset_rune_t', 'struct_r_charset_t',
    'struct_r_cons_bind_t', 'struct_r_cons_canvas_line_style_t',
    ...
    'struct_r_graph_edge_t', 'struct_r_graph_node_t',
    'struct_r_graph_t', 'struct_r_graph_visitor_t', 'struct_r_hud_t',
    ...
    'struct_r_log_source_t', 'struct_r_log_t', 'struct_r_mem_pool_t',
    'struct_r_mmap_t', 'struct_r_num_calc_t', 'struct_r_num_t',
    ...
    'struct_r_pvector_t', 'struct_r_selection_widget_t',
    'struct_r_stack_t', 'struct_r_str_constpool_t',
    'struct_r_th_cond_t', 'struct_r_th_lock_t',
    'struct_r_th_lock_t_0', 'struct_r_th_pool_t', 'struct_r_th_sem_t',
    'struct_r_th_t', 'struct_r_vector_t', 'struct_random_data',
    'struct_rcolor_t', 'struct_rusage', 'struct_sched_param',
    'struct_sdb_diff_t', 'struct_sdb_gperf_t', 'struct_sdb_kv',
    'struct_sdb_ns_t', 'struct_sdb_t', 'struct_sigaction',
    'struct_sigcontext', 'struct_sigevent',
    'struct_sigevent_0__sigev_thread', 'struct_siginfo_t',
    'struct_siginfo_t_0_4_0__addr_bnd', 'struct_siginfo_t_0__kill',
    'struct_siginfo_t_0__rt', 'struct_siginfo_t_0__sigchld',
    'struct_siginfo_t_0__sigfault', 'struct_siginfo_t_0__sigpoll',
    'struct_siginfo_t_0__sigsys', 'struct_siginfo_t_0__timer',
    'struct_sigstack', 'struct_sockaddr', 'struct_sockaddr_storage',
    'struct_stack_t', 'struct_stat', 'struct_termio',
    'struct_termios', 'struct_timespec', 'struct_timeval',
    'struct_timezone', 'struct_tm', 'struct_ucontext_t',
    'struct_winsize', 'strxfrm', 'strxfrm_l', 'suseconds_t',
    'swprintf', 'swscanf', 'symlink', 'symlinkat', 'sync', 'syscall',
    'sysconf', 'system', 'tan', 'tanf', 'tanh', 'tanhf', 'tanhl',
    'tanl', 'tcdrain', 'tcflag_t', 'tcflow', 'tcflush', 'tcgetattr',
    'tcgetpgrp', 'tcgetsid', 'tcsendbreak', 'tcsetattr', 'tcsetpgrp',
    'telldir', 'tempnam', 'tgamma', 'tgammaf', 'tgammal', 'time',
    'time_t', 'timegm', 'timelocal', 'timer_create', 'timer_delete',
    'timer_getoverrun', 'timer_gettime', 'timer_settime', 'timer_t',
    'timespec_get', 'timezone', 'tmpfile', 'tmpnam', 'tmpnam_r',
    'toascii', 'tolower', 'tolower_l', 'toupper', 'toupper_l',
    'trunc', 'truncate', 'truncf', 'truncl', 'ttyname', 'ttyname_r',
    'ttyslot', 'tzname', 'tzset', 'u_char', 'u_int', 'u_int16_t',
    ...
    'ungetc', 'ungetwc', 'union_RNumFloat',
